...
function js_beautify(t, e, i, n) {
    ...
    for (m = t, x = "", g = "TK_START_EXPR", v = "", h = [], K = !1, L = !1, z = !1, T = "\n\r\t ".split(""), k = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split(""), w = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |=".split(" "), C = "continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(","), b = "BLOCK", _ = [b], n = n || 0, A = 0, N = !1;;) {
        ...
        case "TK_WORD":
            ...
            O = "NONE",
            "TK_END_BLOCK" === g ? f(y.toLowerCase(), ["else", "catch", "finally"]) ? (O = "SPACE", o()) : O = "NEWLINE": "TK_END_COMMAND" !== g || "BLOCK" !== b && "DO_BLOCK" !== b ? "TK_END_COMMAND" === g && "EXPRESSION" === b ? O = "SPACE": "TK_WORD" === g ? O = "SPACE": "TK_START_BLOCK" === g ? O = "NEWLINE": "TK_END_EXPR" === g && (o(), O = "NEWLINE") : O = "NEWLINE",
            "TK_END_BLOCK" !== g && f(y.toLowerCase(), ["else", "catch", "finally"]) ? a() : f(y, C) || "NEWLINE" === O ? "else" === v ? o() : ("TK_START_EXPR" !== g && "=" !== v || "function" !== y) && ("TK_WORD" !== g || "return" !== v && "throw" !== v ? "TK_END_EXPR" !== g ? "TK_START_EXPR" === g && "var" === y || ":" === v || ("if" === y && "TK_WORD" === g && "else" === x ? o() : a()) : f(y, C) && ")" !== v && a() : o()) : "SPACE" === O && o(),
            s(),
            x = y,
            "var" === y && (L = !0, z = !1);
            break;
        ...
        case "TK_OPERATOR":
            ...
            "--" === y || "++" === y ? ";" === v ? (P = !0, R = !1) : (P = !1, R = !1) : "!" === y && "TK_START_EXPR" === g ? (P = !1, R = !1) : "TK_OPERATOR" === g ? (P = !1, R = !1) : "TK_END_EXPR" === g ? (P = !0, R = !0) : "." === y ? (P = !1, R = !1) : ":" === y && (P = !!v.match(/^\d+$/)),
            P && o(),
            s(),
            R && o();
            break;
...
function(t) {
    ...
    s.prototype.build = function(t, e) {
        ...
        return a.ie && a.ie < 8 ? s.removeClass("layui-hide").addClass("layui-show") : (u[0] && u.remove(), r.call(n, m, s[0], f), s.addClass("layui-hide").after(m), layui.use(["colorpicker", "jquery"],
        function() {
            for (var t = layui.colorpicker,
            e = (layui.jquery, 0); e <= n.index; e++) t.render({
                elem: "#layBkColor_" + e,
                predefine: !0,
    ...
    var r = function(t, e, n) {
        ...
        function() {
            ...
            r = o.find("head"),
            d = i(["<style>", "*{margin: 0; padding: 0;}", "body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}", "a{color:#01AAED; text-decoration:none;}a:hover{color:#c00}", "p{margin-bottom: 10px;text-align:left !important}", "video{max-width:400px;}", "td{border: 1px solid #DDD;width:80px}", "table{border-collapse: collapse;}", 'a[name]:before{content:"§";color: #01aaed;font-weight: bold;}', "img{display: inline-block;  vertical-align: middle;}", "pre{margin: 10px 0; padding: 10px; line-height: 20px; border: 1px solid #ddd; border-left-width: 6px; background-color: #F2F2F2; color: #333; font-family: Courier New; font-size: 12px;", "</style>"].join("")),
            c = o.find("body"),
            f = function() {
                var t = [];
    ...
    u = function(t, e, l, o) {
        ...
        function(t) {
            ...
            if (8 === e) {
                ...
                if ("<hr>" == c.innerHTML && "BODY" == c.tagName && (d.selectNode(c.childNodes[0]), d.deleteContents()), c.hasChildNodes() && "BODY" != c.tagName) {
                    var f = o.calldel;
                    s.execCommand("formatBlock", !1, "<p>");
                    if ("" != f.url&&"IMG" == d.commonAncestorContainer.childNodes[d.startOffset - 1].tagName) {
                        $.ajax({
                            url:f.url,
                            type:'post',
                            datatype:'json',
            ...
            setTimeout(function() {
                if (t.ctrlKey && 66 == e) {
                    ...
                    r.find("b").each(function() {
                        i.innerText = this.innerText,
                        this.outerHTML = i.outerHTML
                    })
                }
                var n = r.html();
                8 == a.ie && (n = n.replace(/<.+>/g,
                function(t) {
                    return t.toLowerCase()
                })),
                o.autoSync && (l.value = n),
                o.onchange(n)
            },
            10)
        }),
        i(l).parents("form").on("submit",
        function() {
            var t = r.html();
        ...
        function(e) {
            ...
            if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items) {
                for (var c = 0,
                u = e.originalEvent.clipboardData.items.length; c < u; c++) {
                    ...
                    if ("file" === h.kind) {
                        ...
                        if (i.ajax({
                            ...
                            if (b.src = x, a.ie) n.msg("暂不支持IE浏览器");
                                ...
                                var _ = m(d);
                                "<br>" == _.innerHTML && (d.selectNode(_), d.deleteContents()),
                                d.deleteContents(),
                                d.insertNode(b)
                            }
    ...
    f = function(t) {
        ...
        t.html(t.html().replace(/<o:p> <\/o:p>/g, "")),
        t.html(t.html().replace(/o:/g, "")),
        t.html(t.html().replace(/<font>/gi, "")),
        t.html(t.html().replace(/<span>/gi, "")),
        t.html(t.html().replace(/<span [^>]+>/gi, "")),
        t.html(t.html().replace(/<\/span>/gi, "")),
        t.html(t.html().replace(/<P>/g, "")),
        t.html(t.html().replace(/<\/P>/g, "")),
        t.html(t.html().replace(/<p><\/p>/g, ""))
    },
    p = function(t) {
    ...
    h = function(t, e, i) {
        ...
        if (o.removeAttribute("text"), a.ie) {
            ...
            var d = m(i);
            d.parentNode;
            "<br>" == d.innerHTML && (i.selectNode(d), i.deleteContents()),
            i.deleteContents(),
            i.insertNode(o),
            "img" == t && "<br>" == d.innerHTML && (l.execCommand("formatBlock", !1, "<p>"), l.execCommand("justifyCenter"), setTimeout(function() {
                $('body').focus()
            },
            10))
        }
    ...
    g = function(t, e, l) {
        ...
        r = {
            ...
            code: function(e) {
                ...
                function(n) {
                    n.code = n.code.replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;"),
                    h.call(t, "pre", {
                        text: n.code,
                        "lay-lang": n.lang,
                        "lay-encode": i.encode,
            ...
            images: function(e) {
                n.open({
                    ...
                    yes: function(i, l) {
                        ...
                        0 === l.find("#imgsPrev").find("img").length ? n.msg("请选择要插入的图片") : ("" != a && (a = "style='" + a + "'"), h.call(t, "p", {
                            text: l.find("#imgsPrev").html().replace(new RegExp(/(style="max-width:70px;margin:2px")/g), a)
                        },
                        e), n.close(i))
                    },
                    btn2: function(t, e) {
                        if (e.find("#imgsPrev img").length > 0) {
                            for (var n = "",
                            a = 0; a < e.find("#imgsPrev img").length; a++) n += e.find("#imgsPrev img")[a].src;
                            var o = l.calldel;
                            "" != o.url && i.post(o.url, {
                                imgpath: n
                            },
                        ...
                        function() {
                            ...
                            e.render({
                                ...
                                before: function(t) {
                                    ...
                                    t.preview(function(t, e, n) { - 1 === s.indexOf(t) && i("#imgsPrev").append('<img data-index="' + t + '" src="' + n + '" alt="' + e.name + '" style="max-width:70px;margin:2px" /> ')
                                    })
                                },
                                allDone: function() {
                                ...
                                error: function(t, e) {
                                    ...
                                    i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src), a.done(e)) : 2 == e.code ? (e.data = e.data || {},
                                    i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src), a.done(e)) : n.msg(e.msg || "上传失败"),
                                    t.find("#imgsPrev img").on("click",
                                    function() {
                                        var t = this.src,
                ...
                n.open({
                    ...
                    yes: function(i, o) {
                        ...
                        if ("" == s.val()) n.msg("请选择一个视频或输入视频地址");
                            ...
                            u = "";
                            a.video.title.length > 0 && d.length > 0 && (u = d[0].options[d[0].selectedIndex].value),
                            h.call(t, "div", {
                                text: c,
                                class: u
                            },
                    ...
                    success: function(t, e) {
                        ...
                        function(e) {
                            ...
                            a.video.title.length > 0 && c.length > 0 && t.find('select[name="theme"]').on("change mouseover",
                            function() {
            ...
            attachment: function(e) {
                n.open({
                    ...
                    btnAlign: "c",
                    yes: function(i, l) {
                        0 === l.find("#filesPrev").find("a").length ? n.msg("请选择要上传的附件") : (h.call(t, "p", {
                    ...
                    success: function(a, o) {
                        ...
                        function() {
                            ...
                            s.render({
                                ...
                                multiple: !0,
                                before: function(t) {
                                    t.preview(function(t, e, n) { - 1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.name + '" >' + e.name + "</a>&nbsp;")
                                    })
                                },
                                allDone: function() {
                                    for (var l = 0; l < d.length; l++) i("#filesPrev").find('a[data-index="' + d[l] + '"]').remove();
                                    r.autoInsert && (h.call(t, "p", {
                                        text: a.find("#filesPrev").html()
                                    },
                                    e), n.close(o))
                                },
                                error: function(t, e) {
                                    ...
                                    0 == t.code ? (t.data = t.data || {},
                                    i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src), r.done(t)) : 2 == t.code ? (n.msg(t.msg || "上传失败"), t.data = t.data || {},
                                    i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src), r.done(t)) : n.msg(t.msg || "上传失败"),
                                    a.find("#filesPrev a").on("click",
                                    function() {
                                        ...
                                        function(e) {
                                            ...
                                            function(e) {
                                                i("#filesPrev").find('a[data-index="' + t + '"]').remove(),
                                                a.done(e)
                                            }) : (n.msg("没有配置回调参数"), i("#filesPrev").find('a[data-index="' + t + '"]').remove()),
                                            n.close(e)
                                        })
                                    })
                                }
            ...
            html: function(e) {
                ...
                if ( - 1 == n.parentElement.nextElementSibling.lastElementChild.id.indexOf("aceHtmleditor")) {
                    ...
                    l.indexOf("</pre>") > -1 && (l = l.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&quot;/g, '"')),
                    l = style_html(l, 4, " ", 80),
                    n.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height:" + n.parentElement.nextElementSibling.clientHeight + "px"),
                    null !== this.parentElement.parentElement.getAttribute("style") && this.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height: " + (this.parentElement.parentElement.offsetHeight - this.parentElement.offsetHeight - 14) + "px"),
                    n.parentElement.nextElementSibling.firstElementChild.style = "position: absolute;left: -32768px;top: -32768px;";
                    var a = document.createElement("div");
                    a.setAttribute("id", n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor"),
                    a.setAttribute("style", "left: 0px;top: 0px;width: 100%;height: 100%"),
                    n.parentElement.nextElementSibling.appendChild(a);
                    var o = ace.edit(n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor");
                    o.setFontSize(14),
                    o.session.setMode("ace/mode/html"),
                    o.setTheme("ace/theme/tomorrow"),
                    o.setValue(l),
                    o.setOption("wrap", "free"),
                    o.gotoLine(0),
                    ...
                    var o = ace.edit(n.parentElement.nextElementSibling.firstElementChild.id + "aceHtmleditor"),
                    s = o.getValue();
                    t.document.body.innerHTML = s,
                    t.document.body.childNodes.forEach(function(t, e, i) {
                    ...
                    this.parentElement.nextElementSibling.firstElementChild.style = "height:" + r + "px",
            ...
            preview: function(t) {
                ...
                n.open({
                    ...
                    maxmin: !0,
                    full: function(t) {
                        t[0].style.height = i(".layui-layer-shade").offsetHeight + "px",
                        t[0].children[1].style.height = i(".layui-layer-shade").offsetHeight - 43 + "px"
                    },
                    min: function(t) {},
                    restore: function(t) {
                        t[0].style.height = document.body.clientHeight - 100 + "px",
                        t[0].children[1].style.height = document.body.clientHeight - 143 + "px"
                    },
                    shadeClose: !0,
                    area: function() {
            ...
            removeformat: function(t) {
                a.execCommand("removeFormat", "strong", "color"),
                setTimeout(function() {
                    s.focus()
                },
                10)
        ...
        c = function() {
            ...
            if (!e.hasClass(o)) {
                ...
                10)) : r[n] && r[n].call(this, c, a),
                y.call(t, d, e)
            }
        },
        u = /image/;
        d.find(">i").on("mousedown",
        function() {
            var t = i(this),
        ...
        g = function(t) {
            ...
            if (null != t && "default" != e.type) {
                n.close(f);
                var a, o;
                if (a = t.target, o = a.parentNode, "custom" == e.type) return e.customEvent(a.tagName, t),
                !1;
                switch (a.tagName) {
                case "IMG":
                    f = n.open({
                ...
                case "VIDEO":
                    ...
                    r = "";
                    s.video.title.length > 0 && (r = AddCustomThemes(s.video.title, s.video.content, s.video.preview)),
                    f = n.open({
                        type: 1,
                        id: "fly-jie-video-upload",
                        title: "视频管理",
                        ...
                        success: function(t, e) {
                            ...
                            function(e) {
                                ...
                                var c = t.find('select[name="theme"]');
                                s.video.title.length > 0 && c.length > 0 && t.find('select[name="theme"]').on("change mouseover",
                                function() {
                                    n.tips("<img src='" + c[0].options[c[0].selectedIndex].attributes["data-img"].value + "' />", this)
                                })
                            })
                    ...
                    f = n.open({
                        ...
                        success: function(t, e) {
                            ...
                            function() {
                                ...
                                case "addnewtr":
                                    for (var a = "<tr>",
                                    s = 0; s < o.children.length; s++) a += "<td></td>";
                                    a += "</tr>",
                                    i(o).after(a)
                                }
                                n.close(e)
                ...
                default:
                    f = n.open({
                        ...
                        success: function(e, s) {
                            ...
                            e.find(".context-menu-delete").on("click",
                            function() {
    ...
    _ = function t(l, a) {
        ...
        function(e) {
            "table" !== i(e.target).attr("layedit-event") && n.close(t.index)
        },
    ...
    A = function t(e, a) {
        ...
        e.hide && (o = ['<li class="layui-form-item" style="display:none">', '<label class="layui-form-label">请选择语言</label>', '<div class="layui-input-block">', '<select name="lang">', '<option value="' + e.
    ...
    default, "</option>", "</select>", "</div>", "</li>"].join(""));
        ...
        r = n.open({
            ...
            title: "插入代码",
            skin: "layui-layer-msg",
            content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">', o, '<li class="layui-form-item layui-form-text">', '<div class="layui-input-block">', '<textarea name="code" lay-verify="required" autofocus="true" class="layui-textarea" style="height: 200px;width:621px"></textarea>', "</div>", "</li>", '<button type="button" id="layedit-code-yes" lay-submit lay-filter="layedit-code-yes" class="layui-btn" style="display: none"> 确定 </button>', "</ul>"].join(""),
            btn: ["确定", "取消"],
            btnAlign: "c",
            yes: function(t, e) {
            ...
            success: function(i, o) {
                l.render("select"),
                l.on("submit(layedit-code-yes)",
                function(i) {
                    n.close(t.index),
                    a && a(i.field, e.hide, e.
                default)
                })
            }
        });
    ...
    C = {
        ...
        fontfamily: '<i class="layui-icon layui-icon-form" title="字体" layedit-event="fontfamily" style="font-size:18px"></i>',
        fontSize: '<i class="layui-icon" title="字体大小" layedit-event="fontSize" style="font-size:15px">Size</i>',
        ...
        removeformat: '<i class="layui-icon layui-icon-template" title="清除文字样式" layedit-event="removeformat" style="font-size:18px"></i>',
